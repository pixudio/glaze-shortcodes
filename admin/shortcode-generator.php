...
/* 
Description: pixudio Shortcode Generator
Author: pixudio 
Version: 1.0 
...
<link rel="stylesheet" href="<?php echo GSHORTCODES_URL, 'admin/css/admin-shortcode.css'; ?>" />
<link rel="stylesheet" href="<?php echo GSHORTCODES_URL, 'admin/css/jquery-ui.css'; ?>" />
<link rel="stylesheet" href="<?php echo hb_recognize_shortcodes_assets_url('fontawesome'); ?>" />
<link rel="stylesheet" href="<?php echo hb_recognize_shortcodes_assets_url('ionicons'); ?>" />
<link rel="stylesheet" href="<?php echo hb_recognize_shortcodes_assets_url('etlinefonts'); ?>" />
<link rel="stylesheet" href="<?php echo hb_recognize_shortcodes_assets_url('bootstrap'); ?>" />
			...
			if('quotegroup' == groupname ) {
				...
				$('.sc-quotes').each(function(){
				   ...
				   var	author 		 = $(this).find('.quote-author').val(),
				   		title 		 = $(this).find('.quote-author-title').val(),
						avatar 		 = $(this).find('.quote-avatar').val(),
						quotecontent = $(this).find('.sc-quote-text').val();
	
						code += ' [hb_quote author="' + author + '" title="' + title + '" avatar="' + avatar + '"] ' + quotecontent + ' [/hb_quote] '; 
			...
			if('clientgroup' == groupname ) {
				...
				$('.sc-clients').each(function(){
				   ...
				   var	client 		 = $(this).find('.client-name').val(),
						...
						code += ' [hb_client url="' + url + '" name="' + client + '" logo="' + logo + '"][/hb_client] '; 
